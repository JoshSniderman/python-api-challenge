...
3. Inside your local git repository, create a directory called **WeatherPy**.

4. Inside the folder you just created, add a new file called `WeatherPy.ipynb`. These will be the main scripts to run for each analysis.
